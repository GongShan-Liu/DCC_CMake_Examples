# 搜索maya模块
# 这个模块搜索maya库和头文件, 这样就可以使用maya API类
# 该模块已在Windows 7、OS X Sierra、Linux Cent OS中成功测试


# 输出变量
# MAYA_LIBRARY_DIR - 指向 "{Maya installation folder}/lib" 的路径
# MAYA_INCLUDE_DIR - devkit文件夹中头文件的路径
# MAYA_LIBRARIES - 单独定义的库


# 设置初始化变量
set(MAYA_VERSION 2018 CACHE STRING "Maya Version") # 可以在终端中通过键入以下内容来覆盖: -DMAYA_VERSION = 2016
